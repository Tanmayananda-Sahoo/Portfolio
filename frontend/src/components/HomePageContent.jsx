  ...
  return (
    <>
      <div className='page-content'>
        <DraggableAvatar />
        <h4 className='home-page-header relative z-10'>
          <SlotText
        ...
        <div className="home-page-resume-btn-container w-fit" style={{ padding: '0.5rem 0 0 0' }}>
          <a
            href="../src/resume/Tanmayananda_Sahoo_Resume.pdf"
            download="Tanmayy_Resume.pdf"
            onMouseEnter={hoverAudio}
